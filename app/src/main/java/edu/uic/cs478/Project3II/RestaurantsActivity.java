...
public  class RestaurantsActivity extends AppCompatActivity implements ListFragments.ListSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleArray = getResources().getStringArray(R.array.restaurants);
        mWebArray = getResources().getStringArray(R.array.restaurantUrls);

        mTitleFrameLayout = (FrameLayout) findViewById(R.id.restaurant_fragment_container);
        mWebFrameLayout = (FrameLayout) findViewById(R.id.restaurantsWeb_fragment_container);

        mfragmentManager = getSupportFragmentManager();
        FragmentTransaction mfragmentTransaction = mfragmentManager.beginTransaction();
        mfragmentTransaction.replace(R.id.restaurant_fragment_container,listFragments);
        mfragmentTransaction.replace(R.id.restaurantsWeb_fragment_container,webFragment);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem){
        if(menuItem.getItemId() == R.id.Attractions){
    ...
    public void onListSelection(int index) {
        ...
        if (!mWebFragment.isAdded()) {
            ...
            fragmentTransaction.add(R.id.restaurantsWeb_fragment_container, mWebFragment);
        ...
        if (mWebFragment.getShownIndex() != index) {
            //change the webpage being displayed on the webView               ///TODO
    ...
    private void LayoutPortrait(){Log.i("porttrait2","portrait2");
        ...
        mWebFrameLayout.setLayoutParams(new LinearLayout.LayoutParams(MATCH_PARENT,MATCH_PARENT));
